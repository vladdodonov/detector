...
import com.dodonov.detector.binance.api.client.BinanceApiError;
...
import com.dodonov.detector.binance.api.client.security.AuthenticationInterceptor;
...
public class BinanceApiServiceGenerator {
    private static final OkHttpClient sharedClient = new OkHttpClient.Builder()
            .pingInterval(2147483647L, TimeUnit.MILLISECONDS)
            .callTimeout(2147483647L, TimeUnit.MILLISECONDS)
            .connectTimeout(2147483647L, TimeUnit.MILLISECONDS)
            .readTimeout(2147483647L, TimeUnit.MILLISECONDS)
            .writeTimeout(2147483647L, TimeUnit.MILLISECONDS)
            .build();
