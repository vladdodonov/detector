...
public interface BinanceApiWebSocketClient extends Closeable {
     ...
     * @return a {@link Closeable} that allows the underlying web socket to be closed.
     */
    Closeable onAggTradeEvent(String symbols, BinanceApiCallback<AggTradeDto> callback);
    ...
    Closeable onAbnormalTradingNoticeEvent(BinanceApiCallback<AbnormalTradingNoticeEvent> callback);

    Closeable onStatisticsEvent(BinanceApiCallback<List<StatisticsDto>> callback);
